...
pass_note_label = tk.Label(root, text="Minimum score to pass: 3", font=('Verdana', 12), fg="blue") #for instruction
...
def restartQuiz():
    ...
    correct = 0
    question_label['text'] = ""
    question_label['bg'] = 'grey'  # for background color
...
watermark_label = tk.Label(root, text="harish-a7", font=('Verdana', 12), fg="gray") #watermark part 
